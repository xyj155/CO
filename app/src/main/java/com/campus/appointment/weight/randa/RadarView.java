package com.campus.appointment.weight.randa;
...
public class RadarView extends View {
    ...
    private void init() {
        ...
        mPaintLine.setColor(getResources().getColor(R.color.player_white));
...
//        centerBitmap = BitmapFactory.decodeResource(getResources(), centerDrawable);
        //设置扫描渲染的shader
        scanShader = new SweepGradient(mWidth / 2, mHeight / 2,
                new int[]{Color.TRANSPARENT, Color.parseColor("#1296db")}, null);
    }
