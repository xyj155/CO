...
public class BottomDialog extends BaseBottomDialog {
    ...
    public BottomDialog create(FragmentManager manager) {
    ...
    @Override
    public void onCancleListener(DialogInterface.OnCancelListener dialog) {
...
//        }
    ...
    public BottomDialog setOnCancelListener(onCancelListener onCancelListeners) {
        onCancelListener = onCancelListeners;
        return this;
    }
    ...
    public BottomDialog setCancleable(boolean mIsCancelOutside) {
        if (mIsCancelOutside) {
